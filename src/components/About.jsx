      ...
      <div className="container-x">
        <div className="mx-auto max-w-2xl">
          <Reveal>
            ...
            {/* "Built to deliver" is a claim — hand off to the evidence, which
                is the next section down. */}
            <a
              href="#projects"
              className="mt-8 inline-flex items-center gap-1.5 text-sm font-semibold text-slate-300 transition-colors hover:text-cyan-glow"
            >
