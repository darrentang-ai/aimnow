...
const tiers = [
  {
    ...
    features: ['Post unlimited projects', 'Notified when bids arrive', 'Browse AI Manager profiles', 'Community support'],
  ...
  },
  {
    ...
    price: 'Custom',
    note: 'Talk to us',
    features: ['Multi-user accounts', 'API access', 'White-label reporting', 'SLA guarantee', 'Dedicated support'],
    cta: 'Contact sales',
    featured: false,
  },
]
